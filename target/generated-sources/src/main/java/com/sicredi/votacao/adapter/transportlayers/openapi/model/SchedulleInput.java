...
public class SchedulleInput   {
  @JsonProperty("name")
  private String name;

  public SchedulleInput name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1) 
  ...
  public boolean equals(Object o) {
    ...
    SchedulleInput schedulleInput = (SchedulleInput) o;
    return Objects.equals(this.name, schedulleInput.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class SchedulleInput {\n");
